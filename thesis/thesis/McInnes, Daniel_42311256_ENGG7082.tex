...
The following table lists the OCPP functionality goals and their completion status. Green indicates complete, red indicates incomplete.
\caption{Use cases for a basic implementation}
...
Resetting a charge station& B11-B12 & Reset & \cellcolor{green}\\
 \hline
Authorization Options& One of C01, C02, C04 & Authorize &\cellcolor{green}\\
 \hline
Transaction Mechanism & E01 (one of S1-S6), E02-E03,
E05, E06 (one of S1-S6), E07-
  ...
  "definitions": {
    ...
    "ChargingStationType": {
      ...
      "properties": {
        ...
        "vendorName": {
          "description": "Identifies the vendor (not necessarily 
          	in a unique manner).\r\n",
          "type": "string",
          "maxLength": 50
        },
