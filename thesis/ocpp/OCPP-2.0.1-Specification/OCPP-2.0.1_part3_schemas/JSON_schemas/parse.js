...
parseJsonFile('./AuthorizeRequest.json')
parseJsonFile('./AuthorizeResponse.json')
...
parseJsonFile('./HeartbeatRequest.json')
parseJsonFile('./HeartbeatResponse.json')
parseJsonFile('./ResetRequest.json')
parseJsonFile('./ResetResponse.json')
