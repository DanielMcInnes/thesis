...
package body ocpp.ReportDataTypeArray is
   procedure Initialize(self: out ocpp.ReportDataTypeArray.T)

   is
   begin
      for i in Index loop
         ReportDataType.Initialize(self.content(i));
   ...
   begin
      ...
      for i in Index loop
         ...
         ReportDataType.parse(msg, msgIndex, self.content(i), tempBool);
   ...
   begin
      ...
      for i in Index loop
         ...
         ReportDataType.To_Bounded_String(self.content(i), dummybounded);
