...
package body ocpp.sampledValueTypeArray is
   procedure Initialize(self: out ocpp.sampledValueTypeArray.T)

   is
   begin
      for i in Index loop
         SampledValueType.Initialize(self.content(i));
   ...
   begin
      ...
      for i in Index loop
         ...
         SampledValueType.parse(msg, tempIndex, self.content(i), tempBool);
   ...
   begin
      ...
      for i in Index loop
         ...
         SampledValueType.To_Bounded_String(self.content(i), dummybounded);
