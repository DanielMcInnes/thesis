...
package body ocpp.additionalInfoTypeArray is
   procedure Initialize(self: out ocpp.additionalInfoTypeArray.T)

   is
   begin
      for i in Index loop
         AdditionalInfoType.Initialize(self.content(i));
   ...
   begin
      ...
      for i in Index loop
         ...
         AdditionalInfoType.parse(msg, tempIndex, self.content(i), tempBool);
   ...
   begin
      ...
      for i in Index loop
         ...
         AdditionalInfoType.To_Bounded_String(self.content(i), dummybounded);
