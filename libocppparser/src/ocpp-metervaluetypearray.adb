...
package body ocpp.meterValueTypeArray is
   procedure Initialize(self: out ocpp.meterValueTypeArray.T)

   is
   begin
      for i in Index loop
         MeterValueType.Initialize(self.content(i));
   ...
   begin
      ...
      for i in Index loop
         ...
         MeterValueType.parse(msg, tempIndex, self.content(i), tempBool);
   ...
   begin
      ...
      for i in Index loop
         ...
         MeterValueType.To_Bounded_String(self.content(i), dummybounded);
