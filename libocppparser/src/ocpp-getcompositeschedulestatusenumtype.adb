-- ocpp-GetCompositeScheduleStatusEnumType.adb

with ocpp.GetCompositeScheduleStatusEnumType; use ocpp.GetCompositeScheduleStatusEnumType;
with NonSparkTypes;

package body ocpp.GetCompositeScheduleStatusEnumType is
