...
package body ocpp.iso15118CertificateHashDataTypeArray is
   procedure Initialize(self: out ocpp.iso15118CertificateHashDataTypeArray.T)

   is
   begin
      for i in Index loop
         OCSPRequestDataType.Initialize(self.content(i));
   ...
   begin
      ...
      for i in Index loop
         ...
         OCSPRequestDataType.parse(msg, tempIndex, self.content(i), tempBool);
   ...
   begin
      ...
      for i in Index loop
         ...
         OCSPRequestDataType.To_Bounded_String(self.content(i), dummybounded);
