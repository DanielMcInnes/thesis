-- ocpp-RegistrationStatusEnumType.adb

with ocpp.RegistrationStatusEnumType; use ocpp.RegistrationStatusEnumType;
with NonSparkTypes;

package body ocpp.RegistrationStatusEnumType is
   ...
   begin
      if (NonSparkTypes.Uncased_Equals(str, "Accepted")) then
         attribute := Accepted;
      elsif (NonSparkTypes.Uncased_Equals(str, "Pending")) then
         attribute := Pending;
   ...
   begin
      case attribute is
         ...
         when Pending => str := To_Bounded_String("Pending");
