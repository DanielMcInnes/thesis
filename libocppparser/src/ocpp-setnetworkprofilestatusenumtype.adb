-- ocpp-SetNetworkProfileStatusEnumType.adb

with ocpp.SetNetworkProfileStatusEnumType; use ocpp.SetNetworkProfileStatusEnumType;
with NonSparkTypes;

package body ocpp.SetNetworkProfileStatusEnumType is
