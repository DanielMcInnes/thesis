...
package ocpp.IdTokenInfoType is
   type T is record
      ...
      cacheExpiryDateTime : NonSparkTypes.IdTokenInfoType.strcacheExpiryDateTime_t.Bounded_String;
      chargingPriority : integer;
      language1 : NonSparkTypes.IdTokenInfoType.strlanguage1_t.Bounded_String;
      evseId : evseIdTypeArray.T;
      groupIdToken : GroupIdTokenType.T;
      language2 : NonSparkTypes.IdTokenInfoType.strlanguage2_t.Bounded_String;
