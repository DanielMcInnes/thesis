...
package body ocpp.VariableAttributeTypeArray is
   procedure Initialize(self: out ocpp.VariableAttributeTypeArray.T)

   is
   begin
      for i in Index loop
         VariableAttributeType.Initialize(self.content(i));
   ...
   begin
      ...
      for i in Index loop
         ...
         VariableAttributeType.parse(msg, msgIndex, self.content(i), tempBool);
   ...
   begin
      ...
      for i in Index loop
         ...
         VariableAttributeType.To_Bounded_String(self.content(i), dummybounded);
